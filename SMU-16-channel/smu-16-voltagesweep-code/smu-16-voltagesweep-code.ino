...
const int sweep_num_steps = (int) gate_end_voltage * 100; // 100 times as many points, per volt, so 1V/100=10mV per division regardless of end voltage
...
void setup() {
  ...
  uint16_t gate_digital_value = (uint16_t)(gate_start_voltage / 3.3 * 4095);
